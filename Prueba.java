...
public class Prueba extends JFrame {
  ...
  public Prueba() {
    ...
    soluciones = NQueens.solve(num_reinas);  // 1 por defecto
    add(BorderLayout.NORTH, headboard());
  ...
  public JPanel bottom_panel() {
    ...
    JLabel total_text = new JLabel("CANTIDAD: ");
  ...
  private void paintSolution(int indexSolution) {
    ...
    for (int i = 0; i < num_reinas; i++) {
      cells[actual.get(i)][i].setText("O");
    }
  }
